...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/about/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%79.%70%61%72%6B%35%37%34@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/sungyeonparkk", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/syparkway", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000000157841351", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=SKXAwssAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
